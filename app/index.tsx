      ...
      >
        ...
        >
          <TouchableOpacity style={{ alignItems: "center" }}>
            <Entypo name="home" size={sizes.mediumSize} color={colors.selectedColor} />
            <Text style={{ color: colors.selectedLabelColor, fontSize: fontSizes.xxSmallFont, fontWeight: 'bold' }}>Home</Text>
          </TouchableOpacity>

          <TouchableOpacity style={{ alignItems: "center" }}>
            <FontAwesome name="money" size={sizes.mediumSize} color={colors.unSelectedItemColor} />
            <Text style={{ color: colors.unSelectedItemColor, fontSize: fontSizes.xxSmallFont, fontWeight: 'bold' }}>Savings</Text>
          </TouchableOpacity>

          <TouchableOpacity style={{ alignItems: "center" }}>
            <FontAwesome name="arrow-circle-o-up" size={sizes.mediumSize} color={colors.unSelectedItemColor}/>
            <Text style={{ color: colors.unSelectedItemColor, fontSize: fontSizes.xxSmallFont, fontWeight: 'bold'}}>Transact</Text>
          </TouchableOpacity>

          <TouchableOpacity style={{ alignItems: "center" }}>
            <FontAwesome name="bitcoin" size={sizes.mediumSize} color={colors.unSelectedItemColor} />
            <Text style={{ color: colors.unSelectedItemColor, fontSize: fontSizes.xxSmallFont, fontWeight: 'bold' }}>Bitcoin</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </SafeAreaProvider>
